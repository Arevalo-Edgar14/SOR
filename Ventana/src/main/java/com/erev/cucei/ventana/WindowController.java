package com.erev.cucei.ventana;
...
public class WindowController {
    ...
    public void leftOnClick(ActionEvent event) {
        textArea.appendText( textField.getText() + '\n' );
    }

    public void centerOnClick(ActionEvent event) {
        textArea.setText( "" );
    }

    public void rightOnClick(ActionEvent event) {
        textArea.setStyle( "-fx-background-color: " + newColor() + ';' +
                             "-fx-text-fill: linear-gradient(from 0% 0% to 100%" +
                             " 200%, repeat, " +
                             newColor() +
                             " 0%, " +
                             newColor() +
        ...
        textArea.lookup( ".content" )
                .setStyle( "-fx-background-color: " + newColor() + ';' );
    }

    private String newColor() {
        Random rand = new Random();
        Color[] colors = new Color[]{Color.TRANSPARENT, Color.ALICEBLUE,
          ...
          , Color.GOLD, Color.GOLDENROD, Color.GRAY, Color.GREEN,
          ...
          Color.POWDERBLUE, Color.PURPLE, Color.RED, Color.ROSYBROWN,
        ...
        final int MIN = 0;
        int color_selected = rand.nextInt( (MAX - MIN) + 1 ) + MIN;
        int r = (int) (255 * colors[color_selected].getRed());
        int g = (int) (255 * colors[color_selected].getGreen());
        int b = (int) (255 * colors[color_selected].getBlue());
